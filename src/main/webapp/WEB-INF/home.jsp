...
<nav class="navbar navbar-expand-lg navbar-light bg-primary border-bottom px-5 py-3 mb-5 text-white">
    <ul class="navbar-nav w-100 d-flex justify-content-between align-items-center">
        ...
        <li class="nav-item">
            ...
            <button popovertarget="info-box" id="info-btn" class="btn btn-sm text-white btn-info">i</button>
            <div id="info-box" popover class="top-10 border rounded shadow p-2 bg-light text-dark">
                <strong>Hint:</strong> To translate a portion of text, select it using your cursor.
            </div>
        </li>
        <li class="nav-item">
            ...
            <c:when test="${posts.content.size() != 0}">
                ...
                <ul class="pagination justify-content-center">
                    <c:forEach begin="1" end="${totalPages}" var="index">
                        <li class="page-item">
                            <a href="/user/home/${index}" class="page-link nav-link">${index}</a>
                        </li>
                    </c:forEach>
                </ul>
            </c:when>
